...
function getCurrentUserRole() {
    ...
    if ($sessionUserId > 0) {
        ...
        $stmt = $conn->prepare("SELECT role FROM admins WHERE username=? LIMIT 1");
...
function checkPageAccess($pageName) {
    ...
    $accessControl = [
        ...
        // نوجوانان بزرگسالان
        'regsiteruser.php' => ['admin', 'manager'],
        'edituser.php' => ['admin', 'manager'],
        'listuser.php' => ['admin', 'manager'],  // فقط مدیر و مدیرکل
        'rollcalluser.php' => ['admin', 'manager', 'user'],  // همه
        'viewuser.php' => ['admin', 'manager'],
