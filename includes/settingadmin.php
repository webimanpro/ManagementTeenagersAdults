...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['delete_database'])) {
        ...
        $tables = ['reportall', 'rollcalluser', 'class', 'users'];
        $success_delete = true;
        
        // حذف فایل‌های پوشه آپلود
            ...
            foreach ($files as $file) {
                if (is_file($file)) {
                    if (!unlink($file)) {
                        ...
                        $errors[] = "خطا در حذف فایل: " . basename($file);
                        break;
                    }
                }
            }
                    ...
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="text-danger">
                                <li>اطلاعات کاربران (جدول users)</li>
                                <li>اطلاعات حضور و غیاب (جدول rollcalluser)</li>
                                <li>اطلاعات دوره‌ها (جدول class)</li>
								<li>اطلاعات گزارشات (جدول reportall)</li>
                                <li>حذف تمامی تصاویر در پوشه آپلود (upload)</li>
                            </ul>
