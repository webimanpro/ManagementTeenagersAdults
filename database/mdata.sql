...
(23, '123', '3423345425', 'لاقلالا', 'ایلایلال', 'یفلایلا', '', '', NULL, NULL, 'عادی', '', '', '', '', '', '', NULL, '2025-10-22 10:53:42', '2025-10-22 10:53:42', '', '', '', '', '', NULL, NULL);
...
--
ALTER TABLE `teen`
  MODIFY `TeenID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
